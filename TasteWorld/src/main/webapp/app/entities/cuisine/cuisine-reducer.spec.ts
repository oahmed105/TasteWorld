...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cuisine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUISINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUISINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUISINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUISINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUISINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUISINE actions', async () => {
      const expectedActions = [
        {
