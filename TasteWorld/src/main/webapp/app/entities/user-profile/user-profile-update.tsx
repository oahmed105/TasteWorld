  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          recipe: userProfileEntity?.recipe?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tasteWorldApp.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="user-profile-internalUser" name="internalUser" data-cy="internalUser" label="Internal User" type="select">
                <option value="" key="0" />
                {users
              ...
              <ValidatedField id="user-profile-recipe" name="recipe" data-cy="recipe" label="Recipe" type="select">
                <option value="" key="0" />
                {recipes
