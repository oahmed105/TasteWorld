package osama.zipcode.project.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, osama.zipcode.project.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, osama.zipcode.project.repository.UserRepository.USERS_BY_EMAIL_CACHE);
