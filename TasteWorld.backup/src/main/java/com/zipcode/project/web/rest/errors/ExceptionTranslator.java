package com.zipcode.project.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.zipcode.project.service.EmailAlreadyUsedException ||
            ex instanceof com.zipcode.project.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.zipcode.project.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.zipcode.project");
    }
}
